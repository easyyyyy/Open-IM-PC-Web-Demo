import { ContactActionTypes, ContactState, SET_BLACK_LIST, SET_FRIEND_APPLICATION_LIST, SET_FRIEND_LIST, SET_GROUP_APPLICATION_LIST, SET_GROUP_LIST, SET_ORIGIN_LIST, SET_UNREAD_COUNT } from "../types/contacts";
